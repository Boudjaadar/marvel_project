...
# Construire la matrice diagonale W
W = diags(weights)

# Enregistrer les wavenumbers et weights dans des fichiers pour vérification
np.savetxt('wavenumbers.txt', wavenumbers)
np.savetxt('weights.txt', weights)

print("Les tableaux wavenumber et weights ont été générés et la matrice diagonale W a été construite.")
